  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
     ...
     <div className='flex justify-center items-center flex-col gap-1.5'>
        <img src={assets.logo_icon} alt="" className='w-[min(22vw,200px)] md:w-[min(20vw,150px)] '/>
        <h2 className="font-['Plus_Jakarta_Sans'] text-gray-300 text-center text-4xl md:text-5xl font-semibold">Instant</h2>
     </div>
    ...
    <form onSubmit={onSubmitHandler} action="" className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
      ...
      {!isDataSubmitted && (
        ...
        <input onChange={(e)=>setPssword(e.target.value)} value={password} type="password" className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='Password' required />
        </>
      )}
